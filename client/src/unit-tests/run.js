...
var _partyManager = __webpack_require__(19);

Object.defineProperty(exports, 'PartyManager', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_partyManager).default;
  }
});
...
var PartyManager = function (_React$Component) {
	_inherits(PartyManager, _React$Component);

	function PartyManager(props) {
		_classCallCheck(this, PartyManager);

		var _this = _possibleConstructorReturn(this, (PartyManager.__proto__ || Object.getPrototypeOf(PartyManager)).call(this, props));

		var gameController = props.gameController;

		var model = gameController.getAppModel('partyManager');
	...
	_createClass(PartyManager, [{
		...
		value: function render() {
			var gameController = this.props.gameController;
...
PartyManager.appName = 'partyManager';
exports.default = PartyManager;
...
var _apps = __webpack_require__(18);
